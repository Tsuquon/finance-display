...
export default function PortfolioPnLChart({
  ...
  const isIntraday = points.length > 0 && points[0].date.includes("T");

  function fmtDate(d: string) {
    if (isIntraday) {
      const date = new Date(d + ":00:00Z");
        ...
        <div className="flex items-start justify-between border-b border-gray-800 px-6 py-4 gap-4">
          <div className="space-y-2 min-w-0">
            ...
            <p className="text-xs text-gray-500">
              Since {new Date(investedAt).toLocaleString("en-US", { month: "long", day: "numeric", year: "numeric", hour: "numeric", minute: "2-digit", hour12: true })}
